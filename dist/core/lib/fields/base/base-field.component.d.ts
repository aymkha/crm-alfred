...
export declare class BaseFieldComponent implements FieldComponentInterface, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BaseFieldComponent, "ng-component", never, { "mode": { "alias": "mode"; "required": false; }; "field": { "alias": "field"; "required": false; }; "record": { "alias": "record"; "required": false; }; "parent": { "alias": "parent"; "required": false; }; "klass": { "alias": "klass"; "required": false; }; }, {}, never, never, false, never>;
}
