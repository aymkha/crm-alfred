...
export declare class LineActionMenuComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<LineActionMenuComponent, "scrm-line-action-menu", never, { "klass": { "alias": "klass"; "required": false; }; "record": { "alias": "record"; "required": false; }; "config": { "alias": "config"; "required": false; }; "limitConfigKey": { "alias": "limitConfigKey"; "required": false; }; }, {}, never, never, false, never>;
}
