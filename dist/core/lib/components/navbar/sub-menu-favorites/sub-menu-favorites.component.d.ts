...
export declare class SubMenuFavoritesComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SubMenuFavoritesComponent, "scrm-sub-menu-favorites", never, { "module": { "alias": "module"; "required": false; }; }, {}, never, never, false, never>;
}
