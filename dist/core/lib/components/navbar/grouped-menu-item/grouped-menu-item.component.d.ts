...
export declare class GroupedMenuItemComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GroupedMenuItemComponent, "scrm-grouped-menu-item", never, { "item": { "alias": "item"; "required": false; }; "subNavCollapse": { "alias": "subNavCollapse"; "required": false; }; }, {}, never, never, false, never>;
}
