...
export declare class NavbarAbstract implements NavbarModel {
     ...
     * Public API
     */
    constructor(routeConverter: RouteConverter, moduleNavigation: ModuleNavigation, preferences: UserPreferenceStore, language: LanguageStore, appState: AppStateStore);
    /**
     * Reset menus
     */
    resetMenu(): void;
