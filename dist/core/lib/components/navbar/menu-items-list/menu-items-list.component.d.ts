...
export declare class MenuItemsListComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MenuItemsListComponent, "scrm-menu-items-list", never, { "items": { "alias": "items"; "required": false; }; "labelKey": { "alias": "labelKey"; "required": false; }; }, {}, never, never, false, never>;
}
