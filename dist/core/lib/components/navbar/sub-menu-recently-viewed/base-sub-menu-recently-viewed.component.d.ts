...
export declare class BaseSubMenuRecentlyViewedComponent implements OnInit, OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BaseSubMenuRecentlyViewedComponent, "scrm-base-sub-menu-recently-viewed", never, { "module": { "alias": "module"; "required": false; }; }, {}, never, never, false, never>;
}
