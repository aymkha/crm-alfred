...
export declare class SearchBarComponent implements OnInit, OnDestroy {
    ...
    constructor(globalSearch: GlobalSearch, languageStore: LanguageStore);
    ngOnInit(): void;
    ngOnDestroy(): void;
    search(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SearchBarComponent, "scrm-search-bar", never, {}, {}, never, never, false, never>;
}
