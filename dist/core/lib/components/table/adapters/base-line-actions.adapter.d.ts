...
export declare abstract class BaseLineActionsAdapter extends BaseRecordActionsAdapter<LineActionData> {
    ...
    protected constructor(actionManager: LineActionActionManager, asyncActionService: AsyncActionService, message: MessageService, confirmation: ConfirmationModalService, language: LanguageStore, selectModalService: SelectModalService, metadata: MetadataStore);
