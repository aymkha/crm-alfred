...
export declare class ListViewRecordPanelActionAdapterFactory {
    ...
    constructor(language: LanguageStore, actionManager: RecordPanelActionManager, asyncActionService: AsyncActionService, message: MessageService, confirmation: ConfirmationModalService, selectModalService: SelectModalService, metadata: MetadataStore);
