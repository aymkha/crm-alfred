...
export declare class BulkActionsAdapter implements BulkActionDataSource {
    ...
    constructor(store: ListViewStore, message: MessageService, confirmation: ConfirmationModalService, selectModalService: SelectModalService, asyncAction: AsyncActionService, metadata: MetadataStore);
    /**
     * Get bulk action
