...
export declare class AppMetadataStore implements StateStore {
    ...
    constructor(recordGQL: EntityGQL, metadata: MetadataStore, language: LanguageStore, themeImages: ThemeImagesStore, config: SystemConfigStore, preferences: UserPreferenceStore, navigation: NavigationStore, adminMetadataStore: AdminMetadataStore);
    /**
     * Clear state
     */
    clear(): void;
