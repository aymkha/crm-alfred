...
export declare class RecordThreadItemActionsAdapterFactory {
    ...
    constructor(language: LanguageStore, actionManager: RecordThreadItemActionManager, asyncActionService: AsyncActionService, message: MessageService, confirmation: ConfirmationModalService, selectModalService: SelectModalService, metadata: MetadataStore);
