...
export declare class RecordThreadListActionsAdapterFactory {
    ...
    constructor(language: LanguageStore, actionManager: RecordThreadListActionManager, asyncActionService: AsyncActionService, message: MessageService, confirmation: ConfirmationModalService, selectModalService: SelectModalService, metadata: MetadataStore);
