...
export declare class SavedFilterActionAdapterFactory {
    ...
    constructor(language: LanguageStore, actionManager: SavedFilterActionManager, asyncActionService: AsyncActionService, message: MessageService, confimation: ConfirmationModalService, selectModalService: SelectModalService, metadata: MetadataStore);
