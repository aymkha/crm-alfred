...
export declare class SubpanelLineActionsAdapter extends BaseRecordActionsAdapter<SubpanelLineActionData> {
    ...
    constructor(store: SubpanelStore, actionManager: SubpanelLineActionManager, asyncActionService: AsyncActionService, message: MessageService, confirmation: ConfirmationModalService, language: LanguageStore, selectModalService: SelectModalService, metadata: MetadataStore);
