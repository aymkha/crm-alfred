...
export declare class SubpanelActionAdapterFactory {
    ...
    constructor(language: LanguageStore, actionManager: SubpanelActionManager, asyncActionService: AsyncActionService, message: MessageService, confimation: ConfirmationModalService, selectModalService: SelectModalService, metadata: MetadataStore);
