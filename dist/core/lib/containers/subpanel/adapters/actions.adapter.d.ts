...
export declare class SubpanelActionsAdapter extends BaseRecordActionsAdapter<SubpanelActionData> {
    ...
    constructor(store: SubpanelStore, language: LanguageStore, actionManager: SubpanelActionManager, asyncActionService: AsyncActionService, message: MessageService, confirmation: ConfirmationModalService, selectModalService: SelectModalService, metadata: MetadataStore);
