...
class DynamicLabelService {
    ...
    static ɵfac = function DynamicLabelService_Factory(t) { return new (t || DynamicLabelService)(i0.ɵɵinject(i1.DataTypeFormatter), i0.ɵɵinject(i2.LanguageStore), i0.ɵɵinject(i3.SystemConfigStore), i0.ɵɵinject(i4.UserPreferenceStore)); };
    static ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: DynamicLabelService, factory: DynamicLabelService.ɵfac, providedIn: 'root' });
}
