...
class UserPreferenceStore {
    ...
    saveBufferStore = new BehaviorSubject(false);
    saveBuffer$;
    subs = [];
    ...
    static ɵfac = function UserPreferenceStore_Factory(t) { return new (t || UserPreferenceStore)(i0.ɵɵinject(i1.CollectionGQL), i0.ɵɵinject(i2.SystemConfigStore), i0.ɵɵinject(i3.ProcessService), i0.ɵɵinject(i4.LocalStorageService)); };
    static ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: UserPreferenceStore, factory: UserPreferenceStore.ɵfac, providedIn: 'root' });
}
