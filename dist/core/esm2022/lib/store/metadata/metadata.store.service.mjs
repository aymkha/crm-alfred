...
class MetadataStore {
    ...
    allModuleStore = new BehaviorSubject(allModulesState);
    allModulesState$ = this.allModuleStore.asObservable();
    resourceName = 'moduleMetadata';
    fieldsMetadata = {
        fields: [
            'id',
            '_id',
    ...
    static ɵfac = function MetadataStore_Factory(t) { return new (t || MetadataStore)(i0.ɵɵinject(i1.EntityGQL), i0.ɵɵinject(i2.AppStateStore)); };
    static ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: MetadataStore, factory: MetadataStore.ɵfac, providedIn: 'root' });
}
