...
class SaveFilterStoreFactory {
    ...
    static ɵfac = function SaveFilterStoreFactory_Factory(t) { return new (t || SaveFilterStoreFactory)(i0.ɵɵinject(i1.RecordFetchGQL), i0.ɵɵinject(i2.SavedFilterSaveGQL), i0.ɵɵinject(i3.AppStateStore), i0.ɵɵinject(i4.LanguageStore), i0.ɵɵinject(i5.MetadataStore), i0.ɵɵinject(i6.MessageService), i0.ɵɵinject(i7.RecordManager), i0.ɵɵinject(i8.FieldManager), i0.ɵɵinject(i9.RecordMapperRegistry), i0.ɵɵinject(i10.BaseSaveRecordMapper), i0.ɵɵinject(i11.SavedSearchRecordMapper)); };
    static ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: SaveFilterStoreFactory, factory: SaveFilterStoreFactory.ɵfac, providedIn: 'root' });
}
