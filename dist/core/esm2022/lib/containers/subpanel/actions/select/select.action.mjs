...
class SubpanelSelectAction extends SubpanelActionHandler {
    ...
    static ɵfac = function SubpanelSelectAction_Factory(t) { return new (t || SubpanelSelectAction)(i0.ɵɵinject(i1.NgbModal), i0.ɵɵinject(i2.MessageService), i0.ɵɵinject(i3.AsyncActionService)); };
    static ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: SubpanelSelectAction, factory: SubpanelSelectAction.ɵfac, providedIn: 'root' });
}
