...
function LineItemsComponent_ng_container_1_ng_container_3_div_1_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("componentType", ctx_r8.getComponentType(itemField_r10.type, itemField_r10.definition))("field", itemField_r10)("klass", ctx_r8.klass)("mode", ctx_r8.mode)("record", item_r5)("parent", ctx_r8.parent)("type", itemField_r10.type);
} }
...
function LineItemsComponent_ng_container_1_ng_container_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(2, LineItemsComponent_ng_container_1_ng_container_3_div_1_div_2_Template, 2, 11, "div", 8);
    i0.ɵɵelementEnd();
