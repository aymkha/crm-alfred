<?php 
 $GLOBALS["dictionary"]["Account"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Lien de réservation',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'reservation_c',
      'vname' => 'LBL_RESERVATION',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsreservation_c',
      'custom_module' => 'Accounts',
    ),
    'ticketmoyentable_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Ticket moyen € / table',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'ticketmoyentable_c',
      'vname' => 'LBL_TICKETMOYENTABLE',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Accountsstatus_du_restaurant_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsgoogle_reviews_range_list_c',
      'custom_module' => 'Accounts',
    ),
    'jjwg_maps_lat_c' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Tables équipées par Alfred',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'tables_equipees_c',
      'vname' => 'LBL_TABLES_EQUIPEES',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'equipement_table_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountstables_equipees_c',
      'custom_module' => 'Accounts',
    ),
    'jjwg_maps_lng_c' => 
    array (
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsgoogle_form_completed_c',
      'custom_module' => 'Accounts',
    ),
    'nbtables_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Nombre de tables',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'nbtables_c',
      'vname' => 'LBL_NBTABLES',
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsgoogle_rating_range_list_c',
      'custom_module' => 'Accounts',
    ),
    'jjwg_maps_address_c' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Lien menu',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'online_menu_url_c',
      'vname' => 'LBL_ONLINE_MENU_URL_C',
      'type' => 'url',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'gen' => '',
      'link_target' => '_self',
      'id' => 'Accountsonline_menu_url_c',
      'custom_module' => 'Accounts',
    ),
    'voice_interview_done_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Voix enregistrée lors de l\'entretien',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsvoice_interview_done_c',
      'custom_module' => 'Accounts',
    ),
    'next_action_date_c' => 
    array (
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsinstagram_c',
      'custom_module' => 'Accounts',
    ),
    'nbreviews_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'nbReviews',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'nbreviews_c',
      'vname' => 'LBL_NBREVIEWS',
      ...
      'enable_range_search' => false,
      'precision' => '8',
      'id' => 'Accountsnbreviews_c',
      'custom_module' => 'Accounts',
    ),
    'nomgerant_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'nomGerant',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'nomgerant_c',
      'vname' => 'LBL_NOMGERANT',
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsnb_tables_range_list_c',
      'custom_module' => 'Accounts',
    ),
    'action_list_c' => 
    array (
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsaction_list_c',
      'custom_module' => 'Accounts',
    ),
    'tables_equipees_alfred_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'tables equipees alfred',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountstables_equipees_alfred_c',
      'custom_module' => 'Accounts',
    ),
    'type_etablissement_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'type etablissement c',
      'required' => false,
      'source' => 'custom_fields',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Prochaine action',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'next_action_c',
      'vname' => 'LBL_NEXT_ACTION_C',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsnext_action_c',
      'custom_module' => 'Accounts',
    ),
    'notemaps_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Note sur Google Maps',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'notemaps_c',
      'vname' => 'LBL_NOTEMAPS',
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Accountsinterest_level_c',
      'custom_module' => 'Accounts',
    ),
    'zone_commerciale_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'zone commerciale c',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountszone_commerciale_c',
      'custom_module' => 'Accounts',
    ),
    'ticket_moyen_range_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'ticket moyen range c',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsticket_moyen_range_c',
      'custom_module' => 'Accounts',
    ),
  ),
  'indices' => 
